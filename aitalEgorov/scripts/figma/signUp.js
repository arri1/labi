...
const signUp = () =>{ 
  ...
  const [valueContrPassword, PasswordContrText] = React.useState('**********');  
  return(
    <View>
      ...
      <View style={styles.textViewReg}>
        <Text style={styles.textRegis}>Регистрация</Text>
      </View>
      ...
      <View style={styleTextInput.passwortContr}>
        <TextInput
          style={styleTextInput.Win}
          onChangeText={text=>PasswordContrText(text)}
          value={valueContrPassword}
        />
      </View>
